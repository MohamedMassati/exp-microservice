...
//Connexion à la base de données MongoDB de la commande-service
...
mongoose.connect(
    ...
    () => {
        console.log(`Commande-Service DB Connected successfuly`);
    }
);
...
app.listen(PORT, () => {
    console.log(`Commande-Service at port:${PORT}`);
});
